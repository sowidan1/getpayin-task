<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            ...
            <div class="col-right">
                <a href="<?php echo e(route('tour.admin.booking.index')); ?>" class="btn btn-info"><?php echo e(__('Reset')); ?></a>
        </div>
        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Download\Applicants Task-20240617T192257Z-001\Applicants Task\ubs-system\tours\modules/Tour/Views/admin/booking/index.blade.php ENDPATH**/ ?>