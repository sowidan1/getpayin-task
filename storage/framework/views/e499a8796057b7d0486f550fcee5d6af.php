            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right">
                        <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Ultra Booking System by')); ?> <a
                            href="<?php echo e(__('https://www.getpayin.com')); ?>" target="_blank"
                        ><?php echo e(__('GetPayIn')); ?></a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="<?php echo e(__('https://www.getpayin.com')); ?>" target="_blank"><?php echo e(__('About Us')); ?></a>
                            <a href="<?php echo e(__('https://www.getpayin.com')); ?>" target="_blank"><?php echo e(__('Contact Us')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH D:\Download\Applicants Task-20240617T192257Z-001\Applicants Task\ubs-system\tours\modules/Layout/admin/app.blade.php ENDPATH**/ ?>