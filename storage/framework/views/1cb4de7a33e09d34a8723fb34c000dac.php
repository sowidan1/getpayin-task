<form id="loginForm" class="bravo-theme-gotrip-login-form y-gap-20" method="POST" action="<?php echo e(route('login')); ?>">
    ...
    <div class="col-12">
        ...
        <?php if(is_enable_registration()): ?>
            <p class="mt-10"><?php echo e(__("Don't have an account yet?")); ?> <a data-bs-toggle="modal" href="#register"
                    class="text-blue-1"><?php echo e(__('Sign up for free')); ?></a></p>
        <?php endif; ?>
    </div>
    <div class="col-12">
    ...
    <div class="col-12">
        <button class="button py-20 -dark-1 bg-blue-1 text-white w-100 form-submit" type="submit">
            ...
            <span class="spinner-grow spinner-grow-sm icon-loading ml-15 d-none" role="status"
            ...
            <div class="col-12">
                ...
                <?php if(setting_item('facebook_enable')): ?>
                    <a href="<?php echo e(url('/social-login/facebook')); ?>"
                        class="button col-12 -outline-blue-1 text-blue-1 py-15 rounded-8 mt-10 cursor-pointer">
                ...
                <?php if(setting_item('google_enable')): ?>
                    <a href="<?php echo e(url('social-login/google')); ?>"
                        class="button col-12 -outline-red-1 text-red-1 py-15 rounded-8 mt-15 cursor-pointer"
                        data-channel="google">
                ...
                <?php if(setting_item('twitter_enable')): ?>
                    <a href="<?php echo e(url('social-login/twitter')); ?>"
                        class="button col-12 -outline-dark-2 text-dark-2 py-15 rounded-8 mt-15 cursor-pointer"
    ...
    <div class="col-12">
        <div class="text-center px-30">
            <?php echo e(__('By creating an account, you agree to our Terms of Service and Privacy Statement.')); ?></div>
    </div>

    <div class="text-center">
        <hr class="p-0 my-2" />
        <h4 class="text-blue-1 fw-300">Demo Login Panel</h4>
        <hr class="p-0 my-2" />
        <div class="row justify-content-center mt-3">
            <button type='button' id="admin-user-demo" class="col-3 button bg-purple-1 -purple-2 text-white px-4 py-3 mx-2">Admin</button>
            <button type='button' id="vendor-user-demo" class="col-3 button bg-red-2 -red-1 text-white px-4 py-3 mx-2">Vendor</button>
        </div>
    </div>
</form>
<?php /**PATH D:\Download\Applicants Task-20240617T192257Z-001\Applicants Task\ubs-system\tours\themes/GoTrip/Layout/auth/login-form.blade.php ENDPATH**/ ?>